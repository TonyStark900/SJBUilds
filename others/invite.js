...
module.exports = {
  ...
  execute(message) {
    ...
    let inviteEmbed = new MessageEmbed()
      ...
      .addField(`Use the following link to add Harmony to your discord server`, 'https://discord.com/api/oauth2/authorize?client_id=890834449774813224&permissions=274881112128&scope=bot', true)
